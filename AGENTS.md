...
# AuropaqPedidos — Guía de trabajo para Codex

## 1. Propósito del archivo

Este archivo define las reglas obligatorias que Codex debe seguir al trabajar en el proyecto **AuropaqPedidos**.

Codex debe utilizar este archivo como guía principal de comportamiento dentro del repositorio.
...
> **El negocio y la arquitectura son definidos por el equipo. Codex implementa lo que está definido y autorizado.**

Codex no debe inventar requisitos ni tomar decisiones arquitectónicas importantes por iniciativa propia.
...
Antes de realizar cambios relevantes, Codex debe consultar la documentación relacionada.
...
Cuando exista una contradicción entre código y documentación, Codex debe:
...
Al implementar una tarea, Codex debe considerar esta prioridad:
...
Codex no debe asumirla como requisito.

Ejemplo:

Si no está definido si una factura puede estar asociada a varios pedidos, Codex no debe inventar la relación.
...
Codex no debe introducir por iniciativa propia:
...
Codex nunca debe confiar únicamente en información enviada desde React.
...
Codex debe detener esa parte e informar.
...
Codex debe ayudar a construir software, pero no debe ocultar las decisiones detrás del código.
...
Cuando Codex proponga una solución técnica relevante, utilizar preferiblemente:
...
Codex debe evitar respuestas del tipo:
...
Cuando termine una tarea, Codex debe ser claro y directo.
...
> **Nosotros decidimos el negocio y la arquitectura. Codex implementa, prueba y reporta.**
